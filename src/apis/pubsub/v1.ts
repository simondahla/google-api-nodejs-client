...
export namespace pubsub_v1 {
  ...
  /**
   * Response for the `ListSnapshots` method.&lt;br&gt;&lt;br&gt; Lists the
   * names of the snapshots on this topic.&lt;br&gt;&lt;br&gt;
   * &lt;b&gt;ALPHA:&lt;/b&gt; This feature is part of an alpha release. This
   * API might be changed in backward-incompatible ways and is not recommended
   * for production use. It is not subject to any SLA or deprecation policy.
   */
  ...
  /**
   * Response for the `ListTopicSnapshots` method.&lt;br&gt;&lt;br&gt; Lists the
   * names of the snapshots on this topic.&lt;br&gt;&lt;br&gt;
   * &lt;b&gt;ALPHA:&lt;/b&gt; This feature is part of an alpha release. This
   * API might be changed in backward-incompatible ways and is not recommended
   * for production use. It is not subject to any SLA or deprecation policy.
  ...
  /**
   * Request for the `Seek` method.&lt;br&gt;&lt;br&gt; Lists the names of the
   * snapshots on this topic.&lt;br&gt;&lt;br&gt; &lt;b&gt;ALPHA:&lt;/b&gt; This
  ...
  /**
   * A snapshot resource.&lt;br&gt;&lt;br&gt; Lists the names of the snapshots
   * on this topic.&lt;br&gt;&lt;br&gt; &lt;b&gt;ALPHA:&lt;/b&gt; This feature
  ...
  export interface Schema$Subscription {
     ...
     * less than 10 minutes.&lt;br&gt;&lt;br&gt; Lists the names of the
     * snapshots on this topic.&lt;br&gt;&lt;br&gt; &lt;b&gt;ALPHA:&lt;/b&gt;
     ...
     * window.&lt;br&gt;&lt;br&gt; Lists the names of the snapshots on this
     * topic.&lt;br&gt;&lt;br&gt; &lt;b&gt;ALPHA:&lt;/b&gt; This feature is part
  ...
  /**
   * Request for the UpdateSnapshot method.&lt;br&gt;&lt;br&gt; Lists the names
   * of the snapshots on this topic.&lt;br&gt;&lt;br&gt;
   * &lt;b&gt;ALPHA:&lt;/b&gt; This feature is part of an alpha release. This
   * API might be changed in backward-incompatible ways and is not recommended
   * for production use. It is not subject to any SLA or deprecation policy.
   */
  ...
  export class Resource$Projects$Snapshots {
     ...
     * @desc Creates a snapshot from the requested subscription.<br><br> Lists
     * the names of the snapshots on this topic.<br><br> <b>ALPHA:</b> This
     * feature is part of an alpha release. This API might be changed in
     * backward-incompatible ways and is not recommended for production use. It
     ...
     * @desc Removes an existing snapshot. <br><br> Lists the names of the
     ...
     * or deprecation policy. When the snapshot is deleted, all messages
     ...
     * @desc Gets the configuration details of a snapshot.<br><br> Lists the
     * names of the snapshots on this topic.<br><br> <b>ALPHA:</b> This feature
     * is part of an alpha release. This API might be changed in
     * backward-incompatible ways and is not recommended for production use. It
     * is not subject to any SLA or deprecation policy.
     ...
     * @desc Lists the existing snapshots.<br><br> Lists the names of the
     * snapshots on this topic.<br><br> <b>ALPHA:</b> This feature is part of an
     * alpha release. This API might be changed in backward-incompatible ways
     * and is not recommended for production use. It is not subject to any SLA
     ...
     * @desc Updates an existing snapshot.<br><br> Lists the names of the
     * snapshots on this topic.<br><br> <b>ALPHA:</b> This feature is part of an
     * alpha release. This API might be changed in backward-incompatible ways
     * and is not recommended for production use. It is not subject to any SLA
     * or deprecation policy. Note that certain properties of a snapshot are not
     * modifiable.
  ...
  export class Resource$Projects$Subscriptions {
     ...
     * snapshot, whichever is provided in the request.<br><br> Lists the names
     * of the snapshots on this topic.<br><br> <b>ALPHA:</b> This feature is
